 ...
 * Math, Science and English marks (marks is between 0 and 100 and
 * if it is out of range print error message “Invalid Input, Marks should between 0 and 100”) and
